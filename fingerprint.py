...
def enroll_fingerprint():
    try:
        ...
        if positionNumber >= 0:
            ...
            lcd.display_message("Fingerprint", "Exists")
            exit(0)
        print('Remove finger...')
...
def mark_attendance_by_fingerprint():
    try:
        lcd.display_message("Place Finger", "Mark Attendance")
        ...
        if positionNumber >= 0:
            ...
            lcd.display_message(student[2], "Present")
            return positionNumber
        else:
            print("First enroll to the database")
            lcd.display_message("Enroll to", "Database")
            exit(0)
...
def get_fingerid():
    try:
        lcd.display_message("Scan Finger to", "Delete Student")
